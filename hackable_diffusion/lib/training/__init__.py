...
from hackable_diffusion.lib.training.discrete_loss import compute_soft_discrete_diffusion_loss
...
from hackable_diffusion.lib.training.discrete_loss import NoWeightSoftDiscreteLoss
